...
static __forceinline uint32_t PIN_SWCLK_TCK_IN  (void) {
  return LPC_GPIO->B[32*PIN_SWCLK_TCK_PORT + PIN_SWCLK_TCK_BIT] & 0x1;
}
...
static __forceinline uint32_t PIN_SWDIO_TMS_IN  (void) {
  return LPC_GPIO->B[32*PIN_SWDIO_TMS_PORT + PIN_SWDIO_TMS_BIT] & 0x1;
}
...
static __forceinline uint32_t PIN_TDI_IN  (void) {
  return LPC_GPIO->B[32*PIN_TDI_PORT + PIN_TDI_BIT] & 0x1;
}
...
static __forceinline void     PIN_TDI_OUT (uint32_t bit) {
  if (bit)
    ...
    LPC_GPIO->CLR[PIN_TDI_PORT] = (1 << PIN_TDI_BIT);
}
...
static __forceinline uint32_t PIN_TDO_IN  (void) {
  return LPC_GPIO->B[32*PIN_TDO_PORT + PIN_TDO_BIT] & 0x1;
}
...
static __forceinline uint32_t PIN_nRESET_IN  (void) {
  return LPC_GPIO->B[32*PIN_nRESET_PORT + PIN_nRESET_BIT] & 0x1;
}
